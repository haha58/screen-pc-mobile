<template>
	<div class="login">
		...
		<div class="login-header">github趋势</div>
...
const onFinish = async () => {
	loginForm.value?.validateFields().then(async (formValues: any) => {
		const postData = {
			user_name: 'yuan' || formValues.userName,
			pass_word: formValues.passWord
		};
		// const token =
		// 	'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OCwidXNlcl9uYW1lIjoiJ3l1YW4nIiwicGFzc193b3JkIjoiIiwiaWF0IjoxNzQyMzUzMzM2LCJleHAiOjE3NDIzODkzMzZ9.sONm2hcCZeKP9aL9JF3SE3R-';
